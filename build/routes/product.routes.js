...
var productsController = _interopRequireWildcard(require("../controllers/product.controller"));
...
router.get('/', [_middlewares.authJwt.verifyToken], productsController.getProducts);
